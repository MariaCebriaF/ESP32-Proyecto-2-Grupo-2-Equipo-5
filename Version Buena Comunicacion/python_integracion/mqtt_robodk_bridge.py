...
def build_topics(base_topic: str) -> dict[str, str]:
    return {
        ...
        "order_request_legacy": f"{base_topic}/pedido",
...
class Bridge:
    ...
    def on_connect(self, client: mqtt.Client, _userdata: Any, _flags: Any, reason_code: Any, _properties: Any = None) -> None:
        ...
        client.subscribe(self.topics["order_request_legacy"])
    ...
    def on_message(self, _client: mqtt.Client, _userdata: Any, msg: mqtt.MQTTMessage) -> None:
        ...
        elif msg.topic == self.topics["order_request"] or msg.topic == self.topics["order_request_legacy"]:
    ...
    def handle_order(self, payload: dict[str, Any]) -> None:
        ...
        result = self.robot.execute_order(reservation.tipo, reservation.posicion, reservation.tipo_id)
